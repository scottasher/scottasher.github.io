const MissionStatement = (props) => {
  return (
    <div className="bg-gray-100 p-10 md:p-20 lg:py-20 lg:px-64">
      <p className="mb-3 text-xl font-semibold text-gray-900 md:text-2xl">
        Deliver great service experiences fast - without the complexity of
        traditional ITSM solutions.Accelerate critical development work and
        deploy.
      </p>
      <p className="font-light text-gray-500 text text-base md:text-lg">
